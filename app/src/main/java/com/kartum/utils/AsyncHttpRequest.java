...
//
//    public static AsyncHttpClient newRequest(Context activity) {
//        AsyncHttpClient client = new AsyncHttpClient();
////        client.addHeader(RequestParamsUtils.SESSION_ID, Utils.getUserToken(activity));
////        client.addHeader(RequestParamsUtils.ACCEPT_LANGUAGE, "" + Utils.getAPIkey(activity));
