...
public class JournalAttendedPopupAdapter extends RecyclerView.Adapter<JournalAttendedPopupAdapter.MyViewHolder> {
    ...
    public JournalAttendedPopupAdapter(Context c) {
        this.context = c;
...
//    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.item_list_sessions_attended, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.checkBoxAttended.setChecked(data.get(position).isSelected);
        holder.tvAttendedName.setText(Utils.nullSafe("" + data.get(position).title));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.tvAttendedName)
        TextView tvAttendedName;
        @BindView(R.id.checkBoxAttended)
        CheckBox checkBoxAttended;
