...
public class JournalEntryListAdapter extends RecyclerView.Adapter<JournalEntryListAdapter.MyViewHolder> {
    ...
    public JournalEntryListAdapter(Context c) {
        this.context = c;
...
//    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.item_journal_entry, parent, false);
...
//        holder.checkBox.setChecked(data.get(position).isSelected);
        holder.tvEntry.setText(Utils.nullSafe(data1.get(position)));
