...
public class ObsChartAdapter extends RecyclerView.Adapter<ObsChartAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    //    public ArrayList<String> data = new ArrayList<>();
//    public JSONArray data = new JSONArray();
    private ArrayList<ObservPresChartRes.Observee> data = new ArrayList<ObservPresChartRes.Observee>();
    Context context;
    Eventlistener mEventlistener;

    public ObsChartAdapter(Context c) {
        this.context = c;
...
//    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.item_obs_chart, parent, false);
