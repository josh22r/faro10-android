...
import com.kartum.LoginActivity;
...
public abstract class AsyncResponseHandlerOk implements Callback {

    private Activity context;

    public AsyncResponseHandlerOk(Activity context) {
        this.context = context;
    }

    public AsyncResponseHandlerOk(Context context) {
        onStart();
    }
